  ...
  <nav className="fixed top-0 left-0 w-full z-50 bg-black bg-opacity-20 backdrop-blur-md border-b border-white border-opacity-20">
    <div className="flex items-center justify-between px-8 py-4 max-w-7xl mx-auto">
      ...
      <ul className="hidden md:flex items-center gap-8 text-lg font-medium text-white">
        ...
        <li><a href="#menu" className="hover:text-amber-400 transition-colors duration-300 px-3 py-2 rounded-lg hover:bg-white hover:bg-opacity-10">Menu</a></li>
        ...
        <li>
          <a href="https://maps.google.com/?q=284+Ziks+Avenue,+Awka,+Anambra+State" target="_blank" rel="noopener noreferrer" className="bg-amber-500 text-red-900 px-6 py-2 rounded-full font-semibold hover:bg-amber-400 transition-all duration-300 transform hover:scale-105 shadow-lg inline-block">
            Get Directions
          </a>
        </li>
      </ul>
...
const App = () => {
      ...
      <section id="menu" className="py-20 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
              ...
              <div key={index} className="group bg-gradient-to-br from-white to-rose-50 rounded-2xl overflow-hidden shadow-2xl hover:shadow-rose-200 transition-all duration-300 transform hover:-translate-y-2 border border-rose-100">
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="md:w-1/2 p-6 flex flex-col justify-center">
                    ...
                    <button className="bg-rose-600 text-white px-6 py-3 rounded-full hover:bg-rose-700 transition self-start shadow-lg">
                      Shop Now
                    </button>
                  </div>
                </div>
          ...
          <div className="text-center mt-12">
            <button className="bg-rose-600 text-white px-10 py-4 rounded-full font-semibold hover:bg-rose-700 transition shadow-xl tracking-wider">
    ...
    return (
      ...
      >
        ...
        <div className="relative container mx-auto px-4 max-w-6xl z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl md:text-7xl font-serif font-bold mb-6 text-white tracking-wide">
              Visit Us
            </h2>
            <p className="text-2xl text-rose-300 max-w-2xl mx-auto font-light">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-rose-700">09039658792</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="text-center space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-rose-600 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-rose-500 transition transform hover:scale-105 shadow-2xl tracking-wider">
                Shop Online
              </button>
              <button className="border-3 border-rose-400 text-rose-200 bg-white bg-opacity-20 px-10 py-4 rounded-full font-bold text-lg hover:bg-rose-400 hover:text-white transition transform hover:scale-105 shadow-2xl tracking-wider">
                Get Directions
              </button>
            </div>
  ...
  const SpecialOffersSection = () => {
    return (
      <section className="py-20 bg-gradient-to-r from-pink-800 to-amber-700 text-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-200 max-w-2xl mx-auto font-light">
              Don't miss out on our exclusive deals and seasonal specials
            </p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-xl border border-amber-300">
              <h3 className="text-2xl font-serif font-bold text-amber-300 mb-4">Lunch Special</h3>
              <p className="text-amber-100 mb-4 font-light">
                Enjoy our chef's selection lunch combo with curry, rice, naan, and dessert
              </p>
              <div className="flex items-center justify-between">
                <span className="text-3xl font-bold text-white">£15.99</span>
                <span className="text-amber-200 line-through">£22.99</span>
              </div>
              <p className="text-sm text-amber-200 mt-2">Available Mon-Fri, 11:30AM - 3:00PM</p>
            </div>
            
            <div className="bg-white bg-opacity-10 backdrop-blur-sm p-8 rounded-xl border border-amber-300">
              <h3 className="text-2xl font-serif font-bold text-amber-300 mb-4">Family Feast</h3>
              <p className="text-amber-100 mb-4 font-light">
                Perfect for 4 people - includes 2 curries, biryani, naan, and appetizers
              </p>
              <div className="flex items-center justify-between">
                <span className="text-3xl font-bold text-white">£79.99</span>
                <span className="text-amber-200 line-through">£95.99</span>
              </div>
              <p className="text-sm text-amber-200 mt-2">Available daily for dine-in and takeout</p>
            </div>
          </div>
        </div>
      </section>
